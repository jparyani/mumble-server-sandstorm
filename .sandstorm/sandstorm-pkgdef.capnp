...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "4nq714w98d4r8kuywt6dd6dd2z5pk969m06j2v42hm66k2s186yh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Mumble server"),

    appVersion = 3,  # Increment this for every release.

    appMarketingVersion = (defaultText = "1.2.8"),
    # Human-readable representation of appVersion. Should match the way you
    # identify versions of your app in documentation and marketing.

    actions = [
      # Define your "new document" handlers here.
      ( title = (defaultText = "New Server"),
        command = .myCommand
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/jparyani/mumble-server-sandstorm",
      ...
      shortDescription = (defaultText = "voip server"),
